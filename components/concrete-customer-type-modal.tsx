...
export function ConcreteCustomerTypeModal({ type, onClose }: CustomerTypeModalProps) {
  ...
  const modalContent = {
    ...
    "general-contractor": {
      title: "General Contractors: Close 40% More Deals with Precise Data",
      benefits: [
    ...
    "structural-engineer": {
      title: "Structural Engineer: 35% Better Project Planning & Pricing",
      benefits: [
